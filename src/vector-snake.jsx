...
export default class VectorSnake extends Component {
  static propTypes = {
    points: PropTypes.arrayOf(protopTypes.shape({
      anchor: PropTypes.shape({x: PropTypes.number, y: PropTypes.number}),
      handleLeft: PropTypes.shape({x: PropTypes.number, y: PropTypes.number}),
      handleRight: PropTypes.shape({x: PropTypes.number, y: PropTypes.number}),
